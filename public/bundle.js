...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var temperature = _state.temperature;
	    var location = _state.location;
	    ...
	    function renderMessage() {
	      if (isLoading) {
	        ...
	        return React.createElement(WeatherMessage, { location: location, temperature: temperature });
	      }
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          null,
	          React.createElement('input', { type: 'text', ref: 'location', placeholder: 'Enter Place' })
	        ),
	        React.createElement(
	          'div',
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=1022c6516d926c0f474660a715ce6112&units=imperial';
